...
public class Main{
    ...
    public static void main(String[] args) throws IOException {
        ...
        int[] months = getYear(Integer.parseInt(str[2]));
        int day = Integer.parseInt(str[1].substring(0,2));
        int tDay = getDays(months, month, day);
        int hour = Integer.parseInt(str[3].substring(0,2));
        int minute = Integer.parseInt(str[3].substring(3,5));
